...
export default function App() {
  ...
  return <Logger user={me.user} babies={me.babies} initialSleep={me.activeSleep} onAdmin={() => setAdminOpen(true)} onLogout={logout} onUserChanged={(user) => setMe((current) => current ? { ...current, user } : current)} />;
}
